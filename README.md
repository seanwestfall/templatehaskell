...
Metaprogramming can be used for the creation of DSL and generative programming. Current common day uses of such techniques include DSLs, specific for testing (see Jasmine, Mocha) and modeling (html) -- and generative meta-programming is used in ORMs (Object-relational mapping) scripts and tools to map database schemas to objects with in web frameworks.
